Dynamic QR
By Safaricom
Generates a dynamic QR code that is scanned by users to initiate specific M-Pesa transactions.
...
This is a response describing the status of the transaction.
...
QR Code Image/Data/String.

String

An alpha-numeric string containing the QR Code