...
const itinerary = [
    {
        ...
        desc: "Step aboard at Mombasa Beach — your captain and crew will brief you on safety before casting off into the creek system.",
    },
    {
        num: "2",
        title: "Enter the mangrove creek",
        desc: "Glide through narrow channels lined with dense mangrove roots. The water is calm and mirror-like, perfect for spotting birdlife and small marine creatures.",
    },
    {
        num: "3",
        title: "Glass-bottom viewing",
        desc: "Switch on the glass-bottom panel and watch the underwater world beneath the boat — tropical fish, crabs, and coral formations in the shallow creek waters.",
    },
    {
        num: "4",
        title: "Mangrove exploration",
        desc: "Navigate deeper into the mangrove forest. Learn about the ecosystem, the role mangroves play in coastal protection, and spot kingfishers and egrets.",
    },
    {
        num: "5",
        title: "Return to base",
        desc: "Cruise back to Mombasa Beach with plenty of photos and a new appreciation for Kenya's coastal wetland ecosystems.",
    },
];
        ...
        <main className="bg-background text-foreground">
            ...
            <section className="relative min-h-screen w-full overflow-hidden bg-black">
                ...
                >
                    <motion.div
                        ...
                        style={{ backgroundImage: `url('${publicPath("/assets/creek-safaris.webp")}')` }}
                        initial={{ scale: 1 }}
                        animate={{ scale: 1.08 }}
                ...
                >
                    <motion.div variants={{
                        ...
                        <span className="text-[10px] font-medium uppercase tracking-[0.2em] text-white/45">
                            Creek Safaris / Mangrove • Mombasa, Kenya
                        </span>
                    </motion.div>
                    ...
                    <motion.p variants={{
                        ...
                        Navigate the serene mangrove creeks of Mombasa with glass-bottom views of marine life beneath the surface.
                    </motion.p>
                    ...
                    <motion.div variants={{
                        ...
                        <a
                            href="https://wa.me/254708485978?text=Hi%20Blue%20Pineapple%2C%20I'd%20like%20to%20book%20the%20Creek%20Safari"
                    ...
                    <motion.div variants={{
                        ...
                        <span className="text-4xl font-medium text-white">Ksh 4,000</span>
            ...
            <section className="relative py-36 px-4 md:px-16 lg:px-24 xl:px-32 w-full overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center text-center">
                    ...
                    >
                        WhatsApp us to reserve your spot on the creek safari experience.
                    </motion.p>
                    <motion.div
