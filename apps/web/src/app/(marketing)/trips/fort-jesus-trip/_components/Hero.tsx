...
/**
 * Minimal Fort Jesus hero:
 * Desktop — boat background + single flyer card + booking
 * Mobile  — original full-bleed experience (unchanged)
 */
export function Hero() {
  ...
  return (
    <>
      {/* Desktop / tablet */}
      <section className="relative hidden overflow-hidden bg-slate-950 pb-10 pt-24 md:block lg:pb-14 lg:pt-28">
        <div className="pointer-events-none absolute inset-0">
          <Image
            src={publicPath('/assets/experiences/fortjesus/setting-sons-hero.jpg')}
            alt=""
            fill
            priority
            ...
            sizes="100vw"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-slate-950/55 via-slate-950/15 to-slate-950/25" />
          <div className="absolute inset-0 bg-gradient-to-r from-slate-950/35 via-transparent to-slate-950/20" />
        </div>

        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-6 md:grid-cols-[minmax(0,1fr)_minmax(20rem,24rem)] lg:gap-10">
            <div className="hero-banner-enter flex justify-center md:justify-start">
              <div className="w-full max-w-2xl rounded-2xl border border-white/60 bg-white p-2 shadow-2xl">
                <Image
                  ...
                  alt="Fort Jesus water taxi information flyer"
                  width={1536}
                  height={1024}
                  priority
