...
export const stops = ["Mtwapa Beach", "Serena", "Bamburi", "Whitesands", "Pirates", "Mombasa Beach", "Nyali", "English Point", "Fort Jesus"] as const;
...
export const quickFares = [
  ...
  { label: "2 segments", price: 700 },
  { label: "3 segments", price: 1000 },
  { label: "Full route (8 segments)", price: 3000 }
];
...
export const itinerary = [
  {
    ...
    tag: "Departure point",
    description: "Step aboard at Mtwapa Beach at 9:30 AM — your captain and crew will brief you on safety before casting off toward Serena Hotel.",
    image: "/assets/experiences/fortjesus/fortstock.webp"
  },
  {
    step: 2,
    title: "Serena Hotel",
    tag: "Stop 1",
    description: "First stop along the coast. A great moment to settle in and feel the ocean breeze as we continue north.",
    image: "/assets/experiences/fortjesus/fort2.webp"
  },
  {
    step: 3,
    title: "Bamburi Beach",
    tag: "Stop 2",
    description: "Glide past Bamburi Beach. Keep an eye out for marine life in the pristine waters here.",
    image: "/assets/experiences/fortjesus/fort2.webp"
  },
  {
    step: 4,
    ...
    tag: "Stop 3",
    description: "Pass the white-sand shores of Whitesands. Possible stop on request for those who want to stretch their legs.",
    image: "/assets/experiences/fortjesus/fort2.webp"
  },
  {
    step: 5,
    title: "Pirates Beach",
    tag: "Stop 4",
    description: "Continue past Pirates Beach. The coastline here offers a rare perspective of the city most visitors never see.",
    image: "/assets/experiences/fortjesus/fort3.webp"
  },
  {
    step: 6,
    ...
    tag: "Stop 5 · 10:30 AM",
    description: "Arrive at Mombasa Beach. From the water you will spot the Likoni ferry crossing, Ras Serani Lighthouse, State House, and Mombasa Hospital.",
    image: "/assets/experiences/fortjesus/fortstock.webp"
  },
  {
    step: 7,
    ...
    tag: "Stops 6 & 7",
    description: "Cruise past Nyali Beach and English Point. The final stretch toward Fort Jesus offers panoramic views of the old harbour.",
    image: "/assets/experiences/fortjesus/fort3.webp"
  },
  {
    step: 8,
    ...
    tag: "Stop 8 · 11:30 AM",
    description: "Dock at the historic harbour beneath the imposing walls of Fort Jesus. Built by the Portuguese in 1593, the fort commands panoramic views of Mombasa&apos;s ancient skyline.",
    image: "/assets/experiences/fortjesus/fortstock.webp"
  },
  {
    step: 9,
    ...
    description: "Step into Old Town&apos;s winding streets lined with carved Swahili doorways, antique shops, and the smell of Kenyan coastal spices.",
    image: "/assets/experiences/fortjesus/fort2.webp"
  }
];
...
export function calculateBooking(origin: Stop, destination: Stop, adults: number, children: number, infants: number = 0, returnTicket: boolean) {
  ...
  return {
    ...
    fareType: returnTicket ? "Return fare" : "One-way fare",
    adultFare: returnTicket ? result.returnAdultFare : result.oneWayAdultFare,
    childFare: returnTicket ? result.returnChildFare : result.oneWayChildFare,
    infantFare: 0,
    subtotal: result.subtotal,
    adultSubtotal: result.adultSubtotal,
    childSubtotal: result.childSubtotal,
    infantSubtotal: result.infantSubtotal,
