...
const itinerary = [
    ...
    },
    {
        ...
        desc: "The boat glides past Nyali, Bamburi, and Shanzu beaches as the sun begins its descent. The sky transforms into shades of gold, amber, and rose.",
    },
    {
        num: "3",
        title: "Anchor for sunset",
        desc: "We drop anchor in a secluded bay for unobstructed views of the sunset over the Indian Ocean. Champagne, soft drinks, and light snacks are served on board.",
    },
    {
        num: "4",
        title: "Return under the stars",
        desc: "With the sky now deep blue and the first stars appearing, we cruise back to Mombasa Beach — a peaceful end to an unforgettable evening.",
    },
];
...
const stats = [
    { value: 2.5, suffix: "", label: "Hours Duration" },
        ...
        <main className="bg-background text-foreground">
            ...
            <section className="relative min-h-screen w-full overflow-hidden bg-black">
                ...
                >
                    ...
                    <motion.p variants={{
                        ...
                        A golden-hour cruise along the Mombasa coastline with champagne, snacks, and unobstructed sunset views.
                    </motion.p>
                    ...
                    <motion.div variants={{
                        ...
                        <a
                            href="https://wa.me/254708485978?text=Hi%20Blue%20Pineapple%2C%20I'd%20like%20to%20book%20the%20Sunset%20Sailing"
                    ...
                    <motion.div variants={{
                        ...
                        <span className="text-4xl font-medium text-white">Ksh 3,000</span>
            ...
            <section className="relative py-36 px-4 md:px-16 lg:px-24 xl:px-32 w-full overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center text-center">
                    ...
                    >
                        Ready for a golden hour cruise?
                    </motion.h2>
                    <motion.p
                    ...
                    >
                        WhatsApp us to reserve your spot on the sunset sailing experience.
                    </motion.p>
                    <motion.div
