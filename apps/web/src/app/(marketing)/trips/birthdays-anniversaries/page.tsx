...
const itinerary = [
    {
        num: "1",
        title: "Private boat briefing",
        desc: "Your captain and crew greet you at Mombasa Beach. We'll brief you on safety, distribute life jackets, and confirm your custom itinerary for the afternoon.",
    },
    {
        num: "2",
        title: "Set sail for your chosen route",
        desc: "Choose between a relaxed harbour cruise, a sunset sailing route, or a longer journey along the coast. The boat is yours for the duration.",
    },
    {
        num: "3",
        title: "Onboard celebration",
        desc: "Bring your own cake, decorations, and playlist, or let us arrange a bespoke package. The crew handles the rest — you simply enjoy the moment.",
    },
    {
        num: "4",
        title: "Photos and memories",
        desc: "With the Kenyan coastline as your backdrop, capture photos and memories that will last a lifetime. We return to base at the agreed time.",
    },
];
...
const stats = [
    ...
    { value: 35, suffix: "+", label: "Guests Max" },
    { value: 100, suffix: "%", label: "Customisable" },
        ...
        <main className="bg-background text-foreground">
            ...
            <section className="relative min-h-screen w-full overflow-hidden bg-black">
                ...
                >
                    <motion.div
                        ...
                        style={{ backgroundImage: `url('${publicPath("/assets/events.webp")}')` }}
                        initial={{ scale: 1 }}
                        animate={{ scale: 1.08 }}
                ...
                >
                    ...
                    <motion.p variants={{
                        ...
                        Celebrate your special day with a private boat charter along the Mombasa coastline. Customisable routes, decoration, and catering available.
                    </motion.p>
                    ...
                    <motion.div variants={{
                        ...
                        <a
                            href="https://wa.me/254708485978?text=Hi%20Blue%20Pineapple%2C%20I'd%20like%20to%20book%20a%20birthday%2Fanniversary%20charter"
            ...
            <section className="relative py-36 px-4 md:px-16 lg:px-24 xl:px-32 w-full overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center text-center">
                    ...
                    >
                        Ready to celebrate on the water?
                    </motion.h2>
                    <motion.p
                    ...
                    >
                        WhatsApp us to plan your private birthday or anniversary charter.
                    </motion.p>
                    <motion.div
