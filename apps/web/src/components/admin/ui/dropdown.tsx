...
export function DropdownContent({
  ...
  return (
    <div
      ...
      className={cn(
        'fade-in-0 zoom-in-95 pointer-events-auto absolute z-99 mt-2 min-w-32 origin-top-right border border-stroke bg-white shadow-1',
        align === 'end' && 'animate-in right-0',
        align === 'start' && 'left-0',
