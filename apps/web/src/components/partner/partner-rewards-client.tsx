...
import { partnerRewardsOptions } from '@/lib/queries/partner';
...
export function PartnerRewardsClient() {
  const currentYear = new Date().getFullYear();
  const { data: summary, isLoading: summaryLoading } = useQuery(partnerRewardsOptions({ year: currentYear }));
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="border border-stroke bg-white p-6 shadow-1">
          <div className="h-5 w-48 mb-4 animate-pulse rounded bg-gray-200" />
          <div className="h-4 w-full animate-pulse rounded bg-gray-200" />
        </div>
        <div className="border border-stroke bg-white p-6 shadow-1">
          <div className="h-5 w-32 mb-4 animate-pulse rounded bg-gray-200" />
