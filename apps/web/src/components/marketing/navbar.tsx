...
export function Navbar({ variant = 'parent' }: NavbarProps) {
    ...
    return (
        <>
            <nav className={`fixed z-50 mx-auto flex w-full max-w-7xl items-center justify-between left-1/2 -translate-x-1/2 mt-4 bg-white/80 px-4 backdrop-blur-md md:px-8 lg:px-12 xl:px-16`}>
                ...
                >
                    <button
                        ...
                        className="inline-flex cursor-pointer items-center gap-1.5 px-5 py-2.5 text-xs font-semibold transition-all duration-500 bg-cyan-950 text-white hover:bg-cyan-900"
                    >
                        Explore Platforms
                    ...
                    >
                        <div className="overflow-hidden bg-white/95 shadow-lg ring-1 ring-black/5 backdrop-blur-md">
